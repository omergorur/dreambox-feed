...
| `enigma2-plugin-extensions-markernumbering` | 1.3r-2 | all | 19 KB | Adsiz markerlar kanal numarasi rezerve etsin (OpenATV davranisi) |
| `enigma2-plugin-extensions-radiovideo` | 1.5 | all | 3.8 MB | Radyo kanallarinda sabit resim yerine video oynat |
| `enigma2-plugin-extensions-zapfollow` | 1.1r-3 | all | 18 KB | Agdan izlenen yayin kutudaki zap ile birlikte kanal degistirsin |
